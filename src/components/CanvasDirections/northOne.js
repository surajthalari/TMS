...
class NorthOne extends Component {
    ...
    updateCanvas(){
        ...
        controlPoint1 = {x: this.refs.canvas.width * (0.7), y: this.refs.canvas.height * (0.3)};
        controlPoint2 = {x: this.refs.canvas.width * (0.7), y: this.refs.canvas.height * (0.3)};
        endPoint = {x: this.refs.canvas.width * (0.7), y: this.refs.canvas.height};
        startz = {x: 0, y: this.refs.canvas.height * (0.4)};
        controlPoint1z = {x: this.refs.canvas.width * (0.6), y: this.refs.canvas.height * (0.4)};
        controlPoint2z = {x: this.refs.canvas.width * (0.6), y: this.refs.canvas.height * (0.4)};
