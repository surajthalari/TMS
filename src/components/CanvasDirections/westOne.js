...
class WestOne extends Component {
    ...
    updateCanvas(){
        ...
        var controlPoint1 = {x: this.refs.canvas.width * (0.3), y: this.refs.canvas.height * (0.3)};
        var controlPoint2 = {x: this.refs.canvas.width * (0.3), y: this.refs.canvas.height * (0.3)};
        ...
        var controlPoint1z = {x: this.refs.canvas.width * (0.4), y: this.refs.canvas.height * (0.4)};
        var controlPoint2z = {x: this.refs.canvas.width * (0.4), y: this.refs.canvas.height * (0.4)};
